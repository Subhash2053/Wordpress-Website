...
function parallaxsome_setup() {
	 ...
	 * to change 'parallaxsome-pro' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'parallaxsome-pro', trailingslashit( get_template_directory() ) . '/languages' );
	 ...
	 * @since 1.0.0
	 */
	add_image_size( 'parallaxsome_project_thumb', 500, 450, true );
    ...
    add_image_size( 'parallaxsome_team_circle', 170, 170, true );
    add_image_size( 'parallaxsome_image_portfolio_layout_two', 365, 365, true );
    add_image_size( 'parallaxsome_team_archive', 500, 500, true );
    add_image_size( 'parallaxsome_blog_home', 370, 245, true );
    add_image_size( 'parallaxsome_item_home', 110, 110, true );
    add_image_size( 'parallaxsome-home-testimonial', 200, 200, true );
    add_image_size('parallaxsome-footer-recent-news','100','60',true);
	...
	register_nav_menus( array(
		'parallaxsome_primary_menu' => esc_html__( 'Primary Menu', 'parallaxsome-pro' ),
		'parallaxsome_top_menu' => esc_html__( 'Top Header Menu', 'parallaxsome-pro' ),
	) );
...
function parallaxsome_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'parallaxsome_content_width', 700 );
}
...
/**
 * Load ParallaxSome Widget fields
 */
require trailingslashit( get_template_directory() ) . '/inc/widgets/widget-fields.php';

/**
 * Load ParallaxSome Pricing Widget
 */
require trailingslashit( get_template_directory() ) . '/inc/widgets/pricing-widget.php';

/**
 * Load ParallaxSome Recent Post Widget
 */
require trailingslashit( get_template_directory() ) . '/inc/widgets/recent-post.php';

/**
 * Load ParallaxSome Recent Blog Widget
 */
require trailingslashit( get_template_directory() ) . '/inc/widgets/recent-blog.php';

/**
 * Load ParallaxSome Footer Info Widget
 */
require trailingslashit( get_template_directory() ) . '/inc/widgets/footer-info.php';
 ...
 */
require trailingslashit(get_template_directory()).'/woocommerce/woocommerce-function.php';

/**
 * Dynamic Styles
 */
require trailingslashit(get_template_directory()).'/assets/css/dynamic-css.php';
require trailingslashit(get_template_directory()).'/inc/dynamic-styles.php';

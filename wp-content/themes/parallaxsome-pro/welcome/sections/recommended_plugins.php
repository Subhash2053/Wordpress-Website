<?php
	...
	if(!empty($pro_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Pro Plugins', 'parallaxsome-pro'); ?></h4>
		<p><?php echo esc_html__('Take Advantage of some of our Premium Plugins', 'parallaxsome-pro'); ?></p>
	...
	if(!empty($free_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Free Plugins', 'parallaxsome-pro'); ?></h4>
		<p><?php echo esc_html__('These Free Plugins might be handy for you.', 'parallaxsome-pro'); ?></p>

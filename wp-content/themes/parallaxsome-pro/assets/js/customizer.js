...
( function( $ ) {
	...
	*/
    ...
    wp.customize( 'about_section_readmore_text', function( value ) {
		value.bind( function( to ) {
			$( '.about-left-desc .read-more a' ).html( to );
		} );
	} );
    wp.customize( 'feature_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-feature .section-title' ).html( to );
		} );
	} );
	wp.customize( 'booking_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-booking .main-title' ).html( to );
		} );
	} );
	wp.customize( 'booking_section_sub_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-booking .title-sub-title h2' ).html( to );
		} );
	} );
	wp.customize( 'booking_section_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-booking .desc-left-booking' ).html( to );
		} );
	} );
	wp.customize( 'booking_section_phone_number', function( value ) {
		value.bind( function( to ) {
			$( '#section-booking .number-left-booking' ).html( to );
		} );
	} );
    wp.customize( 'cta_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-cta .section-title' ).html( to );
		} );
	} );
    wp.customize( 'cta_section_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-cta .section-description' ).html( to );
		} );
	} );
    wp.customize( 'cta_button_one_text', function( value ) {
		value.bind( function( to ) {
			$( '#section-cta .cta-link a:first-child' ).html( to );
		} );
	} );
    wp.customize( 'cta_button_two_text', function( value ) {
		value.bind( function( to ) {
			$( '#section-cta .cta-link a:last-child' ).html( to );
		} );
	} );
    wp.customize( 'quick_link_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-quicklink .section-title' ).html( to );
		} );
	} );
    wp.customize( 'quick_link_section_subject_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-quicklink .subject-link h3' ).html( to );
		} );
	} );
    wp.customize( 'quick_link_section_subject_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-quicklink .quick-desc' ).html( to );
		} );
	} );
    wp.customize( 'quick_link_section_button_text', function( value ) {
		value.bind( function( to ) {
			$( '#section-quicklink .link-button a' ).html( to );
		} );
	} );
    wp.customize( 'faq_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-faq .section-title' ).html( to );
		} );
	} );
    wp.customize( 'faq_section_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-faq .section-description' ).html( to );
		} );
	} );
    wp.customize( 'pricing_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-pricing .section-title' ).html( to );
		} );
	} );
    wp.customize( 'pricing_section_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-pricing .section-description' ).html( to );
		} );
	} );
    wp.customize( 'skill_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-skill .section-title' ).html( to );
		} );
	} );
    wp.customize( 'skill_section_description', function( value ) {
		value.bind( function( to ) {
			$( '#section-skill .section-description' ).html( to );
		} );
	} );
	wp.customize( 'item_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-item .section-title' ).html( to );
		} );
	} );
	wp.customize( 'item_section_sub_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-item .section-sub-title' ).html( to );
		} );
	} );
    wp.customize( 'video_section_title', function( value ) {
		value.bind( function( to ) {
			$( '#section-video .right-desc' ).html( to );
		} );
	} );

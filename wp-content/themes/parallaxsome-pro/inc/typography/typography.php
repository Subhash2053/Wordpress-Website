...
add_action( 'customize_register', 'parallaxsomepro_customize_register', 15 );
function parallaxsomepro_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'typography', array( 'priority' => 21, 'title' => esc_html__( 'Typography Settings', 'parallaxsome-pro' ) ) );

	// Add the `<p>` typography section.
	$wp_customize->add_section( 'p_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Body', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'p_typography',
			array(
				'label'       => esc_html__( 'Body Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h1_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H1)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h1_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h1_typography',
			array(
				'label'       => esc_html__( 'Header1 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h2_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H2)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h2_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h2_typography',
			array(
				'label'       => esc_html__( 'Header2 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h3_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H3)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h3_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h3_typography',
			array(
				'label'       => esc_html__( 'Header3 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h4_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H4)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h4_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h4_typography',
			array(
				'label'       => esc_html__( 'Header4 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h5_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H5)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h5_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h5_typography',
			array(
				'label'       => esc_html__( 'Header5 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'h6_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Header (H6)', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_setting( 'h6_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			'h6_typography',
			array(
				'label'       => esc_html__( 'Header6 Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'hm_sec_title_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Home Section Title Typography', 'parallaxsome-pro' ) )
	);
	$wp_customize->add_setting( 'hm_sec_title_font_family', array( 'default' => 'Open Sans',  'sanitize_callback' => 'sanitize_text_field', 'transport' => 'postMessage' ) );
	...
	$wp_customize->add_setting( 'hm_sec_title_text_transform', array( 'default' => 'none', 'sanitize_callback' => 'sanitize_text_field', 'transport' => 'postMessage' ) );
	$wp_customize->add_setting( 'hm_sec_title_font_size',   array( 'default' => '16', 'sanitize_callback' => 'absint', 'transport' => 'postMessage' ) );
	$wp_customize->add_setting( 'hm_sec_title_line_height', array( 'default' => '1.5', 'sanitize_callback' => 'sanitize_text_field','transport' => 'postMessage' ) );
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			array(
				'label'       => esc_html__( 'Home Section Title Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
	...
	$wp_customize->add_section( 'hm_sec_subtitle_typography', 
		array( 'panel' => 'typography', 'title' => esc_html__( 'Home Section Sub-Title Typography', 'parallaxsome-pro' ) )
	);
	...
	$wp_customize->add_control(
		new Customizer_Typo_Control_Typography(
			...
			array(
				'label'       => esc_html__( 'Home Section Sub-Title Typography', 'parallaxsome-pro' ),
				'description' => esc_html__( 'Select how you want your paragraphs to appear.', 'parallaxsome-pro' ),
...
function parallaxsome_pro_body_class( $classes ) {
	return array_merge( $classes, array( 'parallaxsome-pro' ) );
}

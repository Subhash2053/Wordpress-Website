 ...
 */
 if(!function_exists('parallaxsome_register_recent_news_widget')){
add_action('widgets_init', 'parallaxsome_register_recent_news_widget');

function parallaxsome_register_recent_news_widget() {
    register_widget('parallaxsome_recent_news');
}
}
if(!class_exists('parallaxsome_recent_news')){
class parallaxsome_recent_news extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
                'parallaxsome_recent_news', esc_html__('parallaxsome : Recent Posts','parallaxsome-pro'), array(
            'description' => esc_html__('A widget that shows Recent News', 'parallaxsome-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'recent_news_title' => array(
                'parallaxsome_widgets_name' => 'recent_news_title',
            ...
            'recent_news_cat' => array(
                'parallaxsome_widgets_name' => 'recent_news_cat',
                'parallaxsome_widgets_title' => esc_html__('Recent Posts Category', 'parallaxsome-pro'),
                'parallaxsome_widgets_field_type' => 'select',
                'parallaxsome_widgets_field_options' => $categories_list
            ),
            'recent_news_posts' => array(
                'parallaxsome_widgets_name' => 'recent_news_posts',
            ...
            'recent_news_image' => array(
                'parallaxsome_widgets_name' => 'recent_news_image',
    ...
    public function widget($args, $instance) {
        ...
        echo $before_widget;
        if($instance){
        $parallaxsome_news_title = $instance['recent_news_title'];
        $parallaxsome_news_cat = $instance['recent_news_cat'];
        $parallaxsome_recent_news_posts = $instance['recent_news_posts'];
        $parallaxsome_image_hide = $instance['recent_news_image'];
        $parallaxsome_enable_date = $instance['recent_enable_date'];
        $parallaxsome_disable_contents = $instance['recent_disable_contents'];
        ?>

        <div class="footer_RN_wrap">
            <?php if($parallaxsome_news_title){ ?>
                <h3 class="widget-title">
                    <?php echo esc_attr($parallaxsome_news_title); ?>
                </h3>
               
            <?php } ?>
            <?php if($parallaxsome_news_cat){ ?>
            <div class="rn_post_wrap <?php if($parallaxsome_image_hide){echo 'no_image';} ?>">
                <?php
                    $parallaxsome_rn_args = array(
                        'post_type' => 'post',
                        'category_name' => $parallaxsome_news_cat,
                        'order' => 'DESC',
                        'posts_per_page' => $parallaxsome_recent_news_posts
                    );

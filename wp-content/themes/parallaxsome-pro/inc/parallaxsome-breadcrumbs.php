...
function parallaxsome_breadcrumbs(){
  /* === OPTIONS === */
	$text['home']     = esc_html__( 'Home', 'parallaxsome-pro' ); // text for the 'Home' link
	$text['category'] = '%s'; // text for a category page
	$text['tax'] 	  = '%s'; // text for a taxonomy page
	$text['search']   = esc_html__( 'Search Results for "%s" Query', 'parallaxsome-pro' ); // text for a search results page
	...
	if (is_home() || is_front_page()) {
		...
		if ( get_query_var('paged') ) {
			...
			echo esc_html__( 'Page', 'parallaxsome-pro' ) . ' ' . get_query_var('paged');
			if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';
		}
		echo '</div>';
	}

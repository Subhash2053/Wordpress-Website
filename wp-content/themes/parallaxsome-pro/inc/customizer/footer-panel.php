		...
		$wp_customize->add_panel(
	        'parallaxsome_footer_settings_panel', 
	        	array(
	            	...
	            	'theme_supports' => '',
	            	'title'          => esc_html__( 'Footer Settings', 'parallaxsome-pro' ),
	            ) 
	    );
...
/*--------------------------------------------------------------------------------------------------------------*/
		...
		$wp_customize->add_section(
	        ...
	        array(
	            'title'		=> esc_html__( 'Footer Widget Settings', 'parallaxsome-pro' ),
	    ...
	    $wp_customize->add_control( new Parallaxsome_Customize_Control_Radio_Image(
	        ...
	        'ps_footer_widget_layout',
	            array(
	                'label'    => esc_html__( 'Footer Widget Layout', 'parallaxsome-pro' ),
	                'description' => esc_html__( 'Choose layout from available layouts', 'parallaxsome-pro' ),
...
/*--------------------------------------------------------------------------------------------------------------*/
		...
		$wp_customize->add_section(
	        ...
	        array(
	            'title'		=> esc_html__( 'Bottom Footer Settings', 'parallaxsome-pro' ),
	            'panel'     => 'parallaxsome_footer_settings_panel',
	            'priority'  => 10,
	        )
	    );
	    ...
	    $wp_customize->add_setting(
	        'ps_copyright_text', 
	            array(
	                'default' => esc_html__( '2016 ParallaxSome', 'parallaxsome-pro' ),
	    ...
	    $wp_customize->add_control(
	        'ps_copyright_text',
	            array(
		            'type' => 'textarea',
		            'label' => esc_html__( 'Copyright Text', 'parallaxsome-pro' ),

...
function parallaxsome_scripts() {
    ...
    wp_enqueue_style( 'mCustomScrollbar',get_template_directory_uri().'/assets/library/custom-scroll/jquery.mCustomScrollbar.css');
    ...
    wp_enqueue_style( 'carousel', get_template_directory_uri() . '/assets/library/owl/owl.carousel.css');
    wp_enqueue_style( 'woocommerce-style', get_template_directory_uri() . '/woocommerce/woocommerce-style.css');
	wp_enqueue_style( 'parallaxsome-style', get_stylesheet_uri() );
    
    wp_enqueue_script( 'parallaxsome-isotope-pkgd', get_template_directory_uri(). '/assets/library/isotope/isotope.pkgd.js',array('jquery'));
    wp_enqueue_script( 'parallaxsome-packery-mode-pkgd', get_template_directory_uri(). '/assets/library/isotope/packery-mode.pkgd.js',array('jquery'));
    wp_enqueue_script( 'parallaxsome-imagesloaded', get_template_directory_uri(). '/assets/library/isotope/imagesloaded.pkgd.js',array('jquery'));
    ...
    wp_enqueue_script( 'mCustomScrollbar',get_template_directory_uri().'/assets/library/custom-scroll/jquery.mCustomScrollbar.js',array('jquery'));
	...
	wp_enqueue_script( 'parallax', get_template_directory_uri() . '/assets/library/parallax-js/js/parallax.js', array( 'jquery' ), '1.4.2', true );
    wp_enqueue_script( 'owl-carousel', get_template_directory_uri() . '/assets/library/owl/owl.carousel.js', array( 'jquery' ), '1.4.2', true );
...
$parallaxsome_single_menu_fields = array(
		'slider' =>  array( 
						'default'=> esc_html__( 'Main', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Top Section', 'parallaxsome-pro' ) 
					),
		'about' =>  array( 
						'default'=> esc_html__( 'About', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'About Us', 'parallaxsome-pro' ) 
					),
        'feature' =>  array( 
						'default'=> esc_html__( 'Feature', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Feature Section', 'parallaxsome-pro' ) 
					),
		'team' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Our Team', 'parallaxsome-pro' ) 
					),
        'booking' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Booking Section', 'parallaxsome-pro' ) 
					),
        'cta' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Call To Action', 'parallaxsome-pro' ) 
					),
		'services' =>  array( 
						'default'=> esc_html__( 'Services', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Our Services', 'parallaxsome-pro' ) 
					),
		'testimonials' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Testimonial Section', 'parallaxsome-pro' ) 
					),
		'fact' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Fact Us', 'parallaxsome-pro' ) 
					),
        'portfolio' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Portfolio Section', 'parallaxsome-pro' ) 
					),
		'quicklink' =>  array( 
						'default'=> esc_html__( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Quick Link', 'parallaxsome-pro' ) 
					),
        'faq' =>  array( 
						'default'=> esc_html__( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'FAQ', 'parallaxsome-pro' ) 
					),
        'pricing' =>  array( 
						'default'=> esc_html__( 'Pricing', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Pricing Table', 'parallaxsome-pro' ) 
					),
        'skill' =>  array( 
						'default'=> esc_html__( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Skill Section', 'parallaxsome-pro' ) 
					),
        'item' =>  array( 
						'default'=> esc_html__( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Item Section', 'parallaxsome-pro' ) 
					),
        'video' =>  array( 
						'default'=> esc_html__( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Video Section', 'parallaxsome-pro' ) 
					),
		'blog' =>  array( 
						'default'=> esc_html__( 'Blog', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Our Blog', 'parallaxsome-pro' ) 
					),
		'clients' =>  array( 
						'default'=> esc_html( '', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Our Clients', 'parallaxsome-pro' ) 
					),
		'contact' =>  array( 
						'default'=> esc_html__( 'Contact', 'parallaxsome-pro' ), 
						'label'=>  esc_html__( 'Contact Us', 'parallaxsome-pro' ) 
					)
	);

$parallaxsome_plx_menu = array(
	'slider' =>  esc_html__( 'Slider (Top Section)', 'parallaxsome-pro' ),
	'about' =>  esc_html__( 'About Us', 'parallaxsome-pro' ),
    'feature' =>  esc_html__( 'Feature Section', 'parallaxsome-pro' ),
	'team' => esc_html__( 'Our Team', 'parallaxsome-pro' ),
    'booking' => esc_html__( 'Booking Section', 'parallaxsome-pro' ),
    'cta' => esc_html__( 'Call To Action', 'parallaxsome-pro' ),
	'services' => esc_html__( 'Our Services', 'parallaxsome-pro' ),
	'testimonials' => esc_html__( 'Testimonial Section', 'parallaxsome-pro' ),
	'fact' => esc_html__( 'Fact Us', 'parallaxsome-pro' ),
    'portfolio' => esc_html__( 'Portfolio Section', 'parallaxsome-pro' ),
	'quicklink' => esc_html__( 'Quick Link', 'parallaxsome-pro' ),
    'faq' => esc_html__( 'FAQ', 'parallaxsome-pro' ),
    'pricing' => esc_html__( 'Pricing Table', 'parallaxsome-pro' ),
	...
	'blog' => esc_html__( 'Our Blog', 'parallaxsome-pro' ),
	'clients' => esc_html__( 'Our Clients', 'parallaxsome-pro' ),
	'contact' => esc_html__( 'Contact Us', 'parallaxsome-pro' ),
);
...
if( ! function_exists( 'parallaxsome_parallax_menu_cb' ) ):
	...
	function parallaxsome_parallax_menu_cb() {
		...
		$menu_order = get_theme_mod('parallaxsome_plx_menu_orders', 'slider, about, feature, team, booking, cta, services, testimonials, fact, portfolio, quicklink, faq, pricing, skill, item, video, blog, clients, contact');
		
		$menu_orderr = str_replace(' ', '', $menu_order);
		$order = explode(',', $menu_orderr);
		
		$ordered = array();
	    foreach ($order as $key) {
	        if (array_key_exists($key, $parallaxsome_single_menu_fields)) {
	            $ordered[$key] = $parallaxsome_single_menu_fields[$key];
	            unset($parallaxsome_single_menu_fields[$key]);
	        }
	    }
	    $plx_menus = $ordered + $parallaxsome_single_menu_fields;
		
		$parallax_menu_type = get_theme_mod( 'parallax_menu_type', 'default' );
		foreach ( $plx_menus as $section_id => $section_value ) {
...
?>
		<nav id="site-navigation" class="main-navigation ps-nav <?php echo esc_attr( $nav_class ); ?>">
		...
		<div class="ps-head-search">
			...
			<?php } ?>
            <?php do_action('parallaxsome_hiddensidebar_action'); ?>
		</div><!-- .ps-head-search -->
<?php 
	}
endif;
...
function parallaxsome_post_lists(){
        wp_reset_postdata();
        $posts = get_posts(array('posts_per_page'   => -1));
        $post_lists = array();
        $post_lists[] = esc_html__('Select post', 'parallaxsome-pro'); 
...
function parallaxsome_homepage_slider_hook() {
	...
	$ps_slider_type = get_theme_mod( 'homepage_slider_type', 'default' );
	$ps_revslider_scode = get_theme_mod( 'parallaxsome_revslider_scode', '' );
	if( $ps_slider_option != 'hide' ) {
?>
	<?php if($ps_slider_type == 'default' && !empty( $ps_slider_cat_id) ) : ?>
		<div id="section-slider" class="ps-front-slider-wrapper">
			<?php
				$ps_slider_args = array(
									'category_name' => $ps_slider_cat_id,
									'posts_per_page' => -1
									);
				$ps_slider_query = new WP_Query( $ps_slider_args );
				if( $ps_slider_query->have_posts() ) {
					echo '<div class="frontSlider">';
							...
							<div class="slider-info">
								<div class="ps-container">
									...
									<span class="slide-button">
										<a href="<?php the_permalink(); ?>"><?php esc_html_e( 'Learn More', 'parallaxsome-pro' ); ?></a>										
									</span>
								</div>
							</div><!-- .slider-info -->
	...
	<?php elseif($ps_revslider_scode != '' && class_exists('RevSliderFront')) : ?>
		<?php echo do_shortcode($ps_revslider_scode); ?>
	<?php endif; ?>
<?php
	}
}
 	...
 	<div class="ps-innerpages-header-wrapper" style="background-image: url(<?php header_image(); ?>);">
 		<div class="ps-container">
	 		<header class="entry-header">
				...
				?>
						<header class="entry-header">
							<h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'parallaxsome-pro' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
						</header><!-- .page-header -->
				<?php
					}
...
?>
		<div class="ps-social-icons-wrapper">
			<?php if( !empty ( $fb_link ) ) { ?> <a href="<?php echo esc_url( $fb_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-facebook"></span></a> <?php } ?>
			<?php if( !empty ( $tw_link ) ) { ?> <a href="<?php echo esc_url( $tw_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-twitter"></span></a> <?php } ?>
			<?php if( !empty ( $ln_link ) ) { ?> <a href="<?php echo esc_url( $ln_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-linkedin"></span></a> <?php } ?>
			<?php if( !empty ( $pin_link ) ) { ?> <a href="<?php echo esc_url( $pin_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-pinterest"></span></a> <?php } ?>
			<?php if( !empty ( $gp_link ) ) { ?> <a href="<?php echo esc_url( $gp_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-google-plus"></span></a> <?php } ?>
			<?php if( !empty ( $yt_link ) ) { ?> <a href="<?php echo esc_url( $yt_link ); ?>" target="_blank"> <span class="ps-social-icon fa fa-youtube"></span></a> <?php } ?>
...
?>
		<header class="section-header">
			...
			<?php if($sub_title){ ?><span class="section-sub-title"><?php echo esc_html( $sub_title ); ?></span><?php } ?>
			<?php if($title){ ?><h2 class="section-title"><?php echo esc_html( $title ); ?></h2><?php } ?>
			<?php if($description){ ?><p class="section-description"><?php echo esc_html( $description ); ?></p><?php } ?>
...
function parallaxsome_get_sidebar() {
    ...
    if(is_post_type_archive('blog')){
            $archive_sidebar = get_theme_mod( 'ps_default_blog_sidebar', 'right_sidebar' );    
    }elseif(is_post_type_archive('team-members')){
        $archive_sidebar = get_theme_mod( 'ps_default_team_sidebar', 'right_sidebar' );
    }else{
    ...
    if( $sidebar_meta_option == 'default_sidebar_layout' ) {
        if( is_single() ) {
            ...
            if( is_post_type_archive('blog') || is_page_template('archive-blog.php')) {
                $archive_sidebar = get_theme_mod( 'ps_default_blog_sidebar', 'right_sidebar' );
                if( $archive_sidebar == 'right_sidebar' ) {
                get_sidebar();
                } elseif( $archive_sidebar == 'left_sidebar' ) {
                    get_sidebar( 'left' );
                }                
            }elseif( is_post_type_archive('team-members') || is_page_template('archive-team-members.php')) {
                $archive_sidebar = get_theme_mod( 'ps_default_team_sidebar', 'right_sidebar' );
                if( $archive_sidebar == 'right_sidebar' ) {
                get_sidebar();
                } elseif( $archive_sidebar == 'left_sidebar' ) {
...
function parallaxsome_team_social_link(){
    global $post;
    
    $parallaxsome_member_facebook_profile = get_post_meta( $post->ID, 'parallaxsome_member_facebook_profile', true );
    $parallaxsome_member_twitter_profile = get_post_meta( $post->ID, 'parallaxsome_member_twitter_profile', true );
    $parallaxsome_member_youtube_profile = get_post_meta( $post->ID, 'parallaxsome_member_youtube_profile', true );
    $parallaxsome_member_linkedin_profile = get_post_meta( $post->ID, 'parallaxsome_member_linkedin_profile', true );
    $parallaxsome_member_instagram_profile = get_post_meta( $post->ID, 'parallaxsome_member_instagram_profile', true );
    $parallaxsome_member_google_profile = get_post_meta( $post->ID, 'parallaxsome_member_google_profile', true );
    
    if($parallaxsome_member_facebook_profile || 
    $parallaxsome_member_twitter_profile || 
    $parallaxsome_member_youtube_profile || 
    $parallaxsome_member_linkedin_profile || 
    $parallaxsome_member_instagram_profile || 
    $parallaxsome_member_google_profile){
        ?>
        <div class="social-icon">
            <?php if($parallaxsome_member_facebook_profile){?> <a href="<?php echo esc_url($parallaxsome_member_facebook_profile); ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a><?php } ?>
            <?php if($parallaxsome_member_twitter_profile){?> <a href="<?php echo esc_url($parallaxsome_member_twitter_profile); ?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a><?php } ?>
            <?php if($parallaxsome_member_youtube_profile){?> <a href="<?php echo esc_url($parallaxsome_member_youtube_profile); ?>" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a><?php } ?>
            <?php if($parallaxsome_member_linkedin_profile){?> <a href="<?php echo esc_url($parallaxsome_member_linkedin_profile); ?>" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a><?php } ?>
            <?php if($parallaxsome_member_instagram_profile){?> <a href="<?php echo esc_url($parallaxsome_member_instagram_profile); ?>" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a><?php } ?>
            <?php if($parallaxsome_member_google_profile){?> <a href="<?php echo esc_url($parallaxsome_member_google_profile); ?>" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a><?php } ?>
        </div>
        <?php
    }
}
function parallaxsome_Category_list(){
    $parallaxsome_cat_lists = get_categories(
        array(
            'hide_empty' => '0',
            'exclude' => '1',
        )
    );
    $parallaxsome_cat_array = array();
    $parallaxsome_cat_array[''] = esc_html__('--Choose--','parallaxsome-pro');
    foreach($parallaxsome_cat_lists as $parallaxsome_cat_list){
        $parallaxsome_cat_array[$parallaxsome_cat_list->slug] = $parallaxsome_cat_list->name;
    }
    return $parallaxsome_cat_array;
}

/**
 * Advance typography settings
*/
if (!function_exists('parallaxsome_get_google_font_variants')) {
  function parallaxsome_get_google_font_variants(){    
      $parallaxsome_font_list = get_option( 'parallaxsome_google_font','' );
      $font_family = $_REQUEST['font_family']; 
      $font_array = parallaxsome_search_key($parallaxsome_font_list,'family', $font_family);
...
add_action("wp_ajax_parallaxsome_get_google_font_variants", "parallaxsome_get_google_font_variants");
...
if(!function_exists('parallaxsome_preloader')){
    function parallaxsome_preloader(){
            $imge_load = get_theme_mod('parallaxsome_pre_loader'); 
            if($imge_load == ''){
                $imge_load = 'loader1';        
            }
            ?>
            <div class="preloader">
                <div><img src="<?php echo get_template_directory_uri().'/assets/images/pre-loader/'.$imge_load.'.gif'; ?>" alt="<?php _e( 'Preloader', 'parallaxsome-pro' ) ?>" /></div>
                <div id="status">&nbsp;</div>
            </div><?php
    }
}
add_action('parallaxsome_preloader_action','parallaxsome_preloader');

function parallaxsome_attachment_id_by_url($image_url) {
	global $wpdb;
	$attachment = $wpdb->get_col($wpdb->prepare("SELECT ID FROM $wpdb->posts WHERE guid='%s';", $image_url )); 
        return $attachment[0]; 
}

function parallaxsome_hiddensidebar(){
    $parallax_menu_type = get_theme_mod('parallax_menu_type');
    if($parallax_menu_type != 'float'){
        $enlighten_enable_hiden_sidebar = get_theme_mod('enable_hidden_sidebar_right');
        if($enlighten_enable_hiden_sidebar == 'show'){
            if(is_active_sidebar('parallaxsome-hidden-sidebar')){
            ?>
                <div class="hidden-sidebar">
                    ...
                    <div class="widgets-hidden">
                        ...
                        <?php dynamic_sidebar('parallaxsome-hidden-sidebar'); ?>
                    </div>
                </div>
            <?php
            }
...
add_action('parallaxsome_hiddensidebar_action','parallaxsome_hiddensidebar');
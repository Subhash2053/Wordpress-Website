...
function parallaxsome_body_classes( $classes ) {
    ...
    if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ){
        if(is_woocommerce()){
            ...
            if( 'post' === get_post_type() || 'team-members' === get_post_type() ) {
                $sidebar_meta_option = get_post_meta( $post->ID, 'ps_post_sidebar_layout', true );
            }
    ...
    $menu_background_header = get_theme_mod('menu_background_header');
    if($menu_background_header == 'white'){
        $classes[] = 'menu-white-background';
    }elseif($menu_background_header == 'white' || $menu_background_header == ''){
        $classes[] = 'menu-no-background';
    }else{
        $classes[] = 'menu-no-background';
    }
